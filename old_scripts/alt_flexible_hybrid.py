...
PATH_STR = '/media/data/mag1/x%s/y%s/z%s/110629_k0725_mag1_x%s_y%s_z%s.raw'
...
def main(idx, move_threshold=0.7, segment_threshold=0.6, validate=False, seed='6,6,8'):
    ...
    config = '''image {hdf5: "%s"}
        ...
        image_stddev: 33
        seed_policy: "%s"
        model_checkpoint_path: "/media/data_cifs/connectomics/ffn_ckpts/wide_fov/htd_cnn_3l_inplace_berson3x_w_inf_memb_r0/model.ckpt-614906"
        model_name: "htd_cnn_3l_inplace.ConvStack3DFFNModel"
