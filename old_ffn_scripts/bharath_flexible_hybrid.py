...
MEM_STR = '/media/data/bkayyar_membranes/mag1/x%s/y%s/z%s/110629_k0725_mag1_x%s_y%s_z%s.raw'
...
def main(idx, move_threshold=0.7, segment_threshold=0.6, validate=False, seed='15,15,17', rotate=False):
    ...
    seg_dir = 'bkayyar_ding_segmentations/x%s/y%s/z%s/v%s/' % (pad_zeros(SEED[0], 4), pad_zeros(SEED[1], 4), pad_zeros(SEED[2], 4), idx)
