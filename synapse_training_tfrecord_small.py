...
def train(
        ...
        epochs=100,
        lr=1e-2,
        train_dataset='/media/data/tf_records/synapses_v6_train.tfrecords',
        test_dataset='/media/data/tf_records/synapses_v6_val.tfrecords',  # Needs to be val
        batch_size=32,
        #  image_size=(1, 160, 160, 160, 2),
        #  label_size=(1, 160, 160, 160, 2),
        summary_dir='tf_summaries/',
        steps_to_save=5000,
        ckpt_path='new_synapse_checkpoints_new_dataloader/',
        rotate=False):
